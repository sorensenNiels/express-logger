...
import { IdempotencyResponse, IIdempotencyResponseValidator } from '../models/models';

/**
 * Implementation of response validator.
 * Check for successful responses.
 */
export class SuccessfulResponseValidator implements IIdempotencyResponseValidator {
  /**
  ...
  public isValidForPersistence(idempotencyResponse: IdempotencyResponse): boolean {
    return idempotencyResponse.statusCode >= 200 && idempotencyResponse.statusCode <= 299;
  }
}
